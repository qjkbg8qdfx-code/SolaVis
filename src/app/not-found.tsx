...
export default function NotFound() {
    return (
        <div className="flex min-h-[80vh] flex-col items-center justify-center px-6 text-center">
            ...
            <h2 className="mb-4 text-4xl font-bold text-gray-900">System Node Missing.</h2>
            <p className="mb-10 max-w-md text-gray-500">
                The requested operational module could not be located. It may have been deprecated
                or moved to a secure sector.
            </p>
